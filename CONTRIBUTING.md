# Contributing
:+1::computer: **Our group members appreciate your contributions!** :computer::+1:

Contributions of all kinds are welcome here, and they are greatly appreciated!
Every little bit helps, and credit will always be given.

## For external arms-length contributors
...
Report bugs at https://github.com/ljy0401/parks_pkg_dsci310_08/issues.
...
parks_pkg_dsci310_08 could always use more documentation, whether as
part of the official documentation, in docstrings, or even on the web in blog
posts, articles, and such. Just
[open an issue](https://github.com/ljy0401/parks_pkg_dsci310_08/issues)
to let us know what you will be working on so that we can provide you with guidance.

### Submit Feedback

The best way to send feedback is to file an issue at
https://github.com/ljy0401/parks_pkg_dsci310_08/issues. If your feedback fits the format of one of
the issue templates, please use that. Remember that this is a volunteer-driven
project and everybody has limited time.

## Get Started!

Ready to contribute? Here's how to set up parks_pkg_dsci310_08 for
local development.

1. Fork the https://github.com/ljy0401/parks_pkg_dsci310_08
   repository on GitHub.
2. Clone your fork locally (*if you want to work locally*)

    ```shell
    git clone git@github.com:your_name_here/parks_pkg_dsci310_08.git
    ```
...
- For core group members, you should follow the [GitHub Flow workflow](https://docs.github.com/en/get-started/using-github/github-flow) for all changes. In particular, you should follow the following steps:
    ...
    2. Make changes.
    3. Commit changes locally and push your branch to the GitHub repo.
    4. Open a Pull Request (PR).
    5. Our team will review your PR.
    6. Address review comments.
    7. Merge your branch into `main`

**We aim to respond to all issues and review pull requests within 7 days.** 
